...
{
  partial class frmServerProcesses
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmServerProcesses));
      ...
      // colValue
      // 
      this.colValue.DataPropertyName = "Status";
      this.colValue.HeaderText = "Status";
      ...
      // Column2
      // 
      this.Column2.DataPropertyName = "hostname";
      ...
      // Column3
      // 
      this.Column3.DataPropertyName = "program_name";
      this.Column3.HeaderText = "Application Name";
      this.Column3.Name = "Column3";
      this.Column3.ReadOnly = true;
      // 
      // Column4
      // 
      this.Column4.DataPropertyName = "memusage";
      this.Column4.HeaderText = "Memory Usage";
      ...
      this.Column5.HeaderText = "CPU Time";
      this.Column5.Name = "Column5";
      this.Column5.ReadOnly = true;
      // 
      // Column6
      // 
      this.Column6.DataPropertyName = "blocked";
      this.Column6.HeaderText = "Blocked";
      this.Column6.Name = "Column6";
      this.Column6.ReadOnly = true;
      // 
      // Column7
      // 
      this.Column7.DataPropertyName = "DB";
      this.Column7.HeaderText = "Database";
      this.Column7.Name = "Column7";
      this.Column7.ReadOnly = true;
      // 
      // Column8
      // 
      this.Column8.DataPropertyName = "cmd";
      this.Column8.HeaderText = "Command Type";
      this.Column8.Name = "Column8";
      this.Column8.ReadOnly = true;
      // 
      // Column9
      // 
      this.Column9.DataPropertyName = "nt_domain";
      this.Column9.HeaderText = "NT Domain";
      this.Column9.Name = "Column9";
      this.Column9.ReadOnly = true;
      // 
      // Column10
      // 
      this.Column10.DataPropertyName = "nt_username";
      this.Column10.HeaderText = "NT User";
      this.Column10.Name = "Column10";
      this.Column10.ReadOnly = true;
      // 
      // Column11
      // 
      this.Column11.DataPropertyName = "net_address";
      this.Column11.HeaderText = "Net Address";
      this.Column11.Name = "Column11";
      this.Column11.ReadOnly = true;
      // 
      // Column12
      // 
      this.Column12.DataPropertyName = "net_library";
      this.Column12.HeaderText = "Net Library";
      ...
      this.Name = "frmServerProcesses";
      this.ShowInTaskbar = false;
      this.TabPageContextMenuStrip = this.contextMenuStrip2;
      this.TabText = "Server Processes";
      this.Text = "Server Processes";
      this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.frmServerProcesses_FormClosed);
