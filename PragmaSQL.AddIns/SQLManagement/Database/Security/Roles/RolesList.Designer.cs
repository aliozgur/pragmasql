namespace SQLManagement
{
  partial class RolesList 
  {
    ...
    private void InitializeComponent( )
    {
      ...
      this.Column7.HeaderText = "Role Name";
      ...
      this.Column4.HeaderText = "Role Type";
      ...
      // Column6
      // 
      this.Column6.DataPropertyName = "creation";
      ...
      // Column3
      // 
      this.Column3.DataPropertyName = "updatedt";
      this.Column3.HeaderText = "Updated";
