...
{
	public class VirtualResultRendererFactory:IResultRendererFactory
	{
		...
		{
			get { return "VirtualRenderer"; }
		}

		public string FactoryDescription
		{
			get { return "Renderer using virtual grid."; }
		}
		...
		{
			VirtualDataGridView grd = sender as VirtualDataGridView;
			if (grd == null)
			{
