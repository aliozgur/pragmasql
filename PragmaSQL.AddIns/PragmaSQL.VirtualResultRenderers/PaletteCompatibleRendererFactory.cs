...
{
	public class PaletteCompatibleRendererFactory:IResultRendererFactory
	{
		...
		{
			get { return "PaletteCompatableRenderer"; }
		}

		public string FactoryDescription
		{
			get { return "Renderer using palette compatable grid."; }
		}
		...
		private void RenderResult(IScriptEditor editor, TabControl tabControl, ScriptExecutionResult execResult)
		{
			...
			TabPage tp = null;
			PaletteCompatibleRenderer grd = null;
			int tblNo = 1;
			foreach (DataSet ds in execResult.DataSets)
			{
				...
				foreach (DataTable tbl in ds.Tables)
				{
					...
					grd = new PaletteCompatibleRenderer();
					tp.Controls.Add(grd);
