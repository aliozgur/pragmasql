...
namespace PragmaSQL
{
  partial class frmObjectExplorer
  {
    ...
    //private void OnScriptDatabaseObjects( object sender, EventArgs e )
    //{
    //  FireBeforeContextMenuActionExecuted(sender, ObjectExplorerAction.ScriptDatabaseObjects);
    //  ShowDatabaseObjectScriptDialog();
    //  FireAfterContextMenuActionExecuted(sender, ObjectExplorerAction.ScriptDatabaseObjects);
    //}
		...
		//private void OnBulkCopyData(object sender, EventArgs e)
		//{
		//  FireBeforeContextMenuActionExecuted(sender, ObjectExplorerAction.BulkCopyData);
		//  ShowBulkCopyDataDialog();
		//  FireAfterContextMenuActionExecuted(sender, ObjectExplorerAction.BulkCopyData);
    ...
    private void OnGenerateDropScript( object sender, EventArgs e )
    {
      ...
      FireAfterContextMenuActionExecuted(sender, ObjectExplorerAction.GenerateDropScript);
		...
		//private void OnGenerateCreateScript(object sender, EventArgs e)
		//{
		//  FireBeforeContextMenuActionExecuted(sender, ObjectExplorerAction.GenerateTableCreateScript);
		//  GenerateTableCreateScriptToScriptWindow();
		//  FireAfterContextMenuActionExecuted(sender, ObjectExplorerAction.GenerateTableCreateScript);
		//}
