...
namespace Menees.DiffUtils.Controls
{
	...
	public class DirDiffControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.TreeB = new Menees.DiffUtils.Controls.DirDiffTreeView();
			...
			this.TreeA = new Menees.DiffUtils.Controls.DirDiffTreeView();
			...
			this.TreeB.MouseWheelMsg += new Menees.DiffUtils.Controls.Win32MessageEventHandler(this.TreeB_MouseWheelMsg);
			...
			this.TreeB.VScroll += new Menees.DiffUtils.Controls.Win32MessageEventHandler(this.TreeB_VScroll);
			...
			// mnuView
			// 
			this.mnuView.Image = global::Menees.DiffUtils.Properties.Resources.View;
			...
			// mnuShowDifferences
			// 
			this.mnuShowDifferences.Image = global::Menees.DiffUtils.Properties.Resources.ShowDifferences;
			...
			this.TreeA.MouseWheelMsg += new Menees.DiffUtils.Controls.Win32MessageEventHandler(this.TreeA_MouseWheelMsg);
			...
			this.TreeA.VScroll += new Menees.DiffUtils.Controls.Win32MessageEventHandler(this.TreeA_VScroll);
			...
			this.btnView.Image = global::Menees.DiffUtils.Properties.Resources.View;
			...
			this.btnShowDifferences.Image = global::Menees.DiffUtils.Properties.Resources.ShowDifferences;
		...
		private Menees.DiffUtils.Controls.DirDiffTreeView TreeB;
		private System.Windows.Forms.Splitter Splitter;
		private Menees.DiffUtils.Controls.DirDiffTreeView TreeA;
