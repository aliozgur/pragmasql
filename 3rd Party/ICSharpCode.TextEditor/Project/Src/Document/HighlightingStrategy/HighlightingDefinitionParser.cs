	...
	public static class HighlightingDefinitionParser
	{
		...
		public static DefaultHighlightingStrategy Parse(DefaultHighlightingStrategy highlighter, SyntaxMode syntaxMode, XmlReader xmlReader)
		{
			...
			try {
				...
				MessageBox.Show("Could not load syntax mode definition file '" + syntaxMode.FileName + "'.\n" + e.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
				return null;
			}
		}
