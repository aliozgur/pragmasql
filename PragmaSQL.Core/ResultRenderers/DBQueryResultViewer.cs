...
{
  public partial class DBQueryResultViewer : UserControl
  {
    ...
    private int _initialPos = -1;
		...
		private IList<PragmaDataGridView> _grids = new List<PragmaDataGridView>();
		public IList<PragmaDataGridView> Grids
    {
			get { return new List<PragmaDataGridView>(_grids).AsReadOnly(); }
    }
    ...
    private PragmaDataGridView _activeGrid = null;
		public PragmaDataGridView ActiveGrid
		{
	...
	public delegate void ActiveGridChangedDelegate(object sender, PragmaDataGridView grd);
}
