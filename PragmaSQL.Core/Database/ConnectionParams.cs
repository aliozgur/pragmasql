...
namespace PragmaSQL.Core
{
	...
	/// </summary>
	[Serializable]
	public class ConnectionParamsCollection : CollectionBase
	{
		public virtual void Add(string Provider, string IntegratedSecurity, string Name, string PersistSecurityInfo,
      string InitialCatalog, string UserName, string Password, string TimeOut, bool IsConnected)
		{
		...
		public virtual ConnectionParams this[int Index]
		{
			get
			{
				return (ConnectionParams)this.List[Index];
			}
		}
