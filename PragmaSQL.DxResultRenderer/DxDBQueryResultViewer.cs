...
{
  public partial class DxDBQueryResultViewer : UserControl
  {
    ...
    private int _initialPos = -1;
		...
		private IList<DxResultRenderer> _grids = new List<DxResultRenderer>();
		public IList<DxResultRenderer> Grids
    {
			get { return new List<DxResultRenderer>(_grids).AsReadOnly(); }
    }
    ...
    public ContextMenuStrip GridContextMenuStrip
    {
      ...
      set { _gridContextMenuStrip = value; }
		...
		private DxResultRenderer _activeGrid = null;
		public DxResultRenderer ActiveGrid
		{
		...
		public void RenderDataTable(IScriptEditor editor, DataTable tbl)
    {
      ...
      _tables.Add(tbl);
			DxResultRenderer grd = new DxResultRenderer();
    ...
    {
			_activeGrid = sender as DxResultRenderer;
	...
	public delegate void ActiveGridChangedDelegate(object sender, DxResultRenderer grd);
}
